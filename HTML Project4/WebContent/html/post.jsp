...
<%
//https://www.google.com/search?q=%EC%9E%90%EB%B0%94&oq=%EC%9E%90%EB%B0%94&aqs=chrome..69i57j35i39j69i59j0l2j69i61l3.908j0j7&sourceid=chrome&ie=UTF-8
	try
	{
	 	  ...
	 	  <% 
	 	   ...
	 	   %>
	 	    <tr>
	 	    	...
	 	    	<td width=75% align=left><a href="javascript:ok('<%=vo.getZipcode()%>','<%=vo.getAddress()%>')"><%=vo.getAddress()%></a></td>
	 	    </tr>
	 	   <%
	 	    } 
	 	   %>
